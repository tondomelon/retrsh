...
import Retrash_bgSlogan_main from '../images/Retrash_bgSlogan-main.svg'
import Dude_with_headphones from '../images/Dude-with-headphones.png'
import Cover_1 from '../images/Covers/magazine/Cover_1.png'
import Cover_2 from '../images/Covers/magazine/Cover_2.png'
import Cover_3 from '../images/Covers/magazine/Cover_3.png'
import Cover_4 from '../images/Covers/magazine/Cover_4.png'
import Cover_5 from '../images/Covers/magazine/Cover_4.png'
import girl_with_themes from '../images/girl-with-themes.svg'
import arrow_button from '../images/arrow-button.svg'
import Star_element from '../images/Star_element.png'
import Sticker_button from '../images/Sticker-button.png'
import arrow_1 from '../images/arrow_1.svg'
import man_on_skate from '../images/man-on-skate.png'
import new_article_content1_left from '../images/new-article_content1-left.png'
import new_article_content1 from '../images/new-article_content1.png'
import new_article_content2_left from '../images/new-article_content2-left.png'
import new_article_content3_left from '../images/new-article_content3-left.png'
import new_article_content3_right from '../images/new-article_content3-right.png'
import new_article_content4 from '../images/new-article_content4.png'
import new_article_content5_left from '../images/new-article_content5-left.png'
      ...
      <section className="section-preview">
        <div className="section1_container container">
          <div className="section1_bgimg">
            <img src={Retrash_bgSlogan_main}/>
          </div>
          <div className="section1_man-headphones">
            <img src={Dude_with_headphones}/>
          </div>
          ...
          <div className="theme-selector">
            <div><img className='theme-hover' src={Cover_1}/></div>
       ...
       <div className="info-square">
          ...
          <section className="section-aboutus">
            <div className="section2-container container">
              <div className="aboutus-left_block">
                <img src={girl_with_themes}/>
                <div><img className='section2-theme sizeBig' src={Cover_4}/></div>
                <div><img className='section2-theme sizeMedium' src={Cover_3}/></div>
                <div><img className='section2-theme sizeSmall' src={Cover_1}/></div>
              </div>
              <div className="aboutus-right_block">
                ...
                <img className="aboutus-arrow_button" src={arrow_button}/>
                </div>
              </div>
              <img className="star-bg" src={Star_element}/>
              <div className="aboutus-sticker_button">
              <img className="aboutus-sticker_bg" src={Sticker_button}/>
              <p>Рандомный выпуск!</p>
              <img className="blue-arrow" src={arrow_1}/>
              </div>
              ...
              <div className="grid_fresh-releases">
                <div className="release_fresh-releases">
                  <div className="opacity_block">
                    ...
                    <ul>
                      <li>От техники не спастись</li>
                      <li>Игромания и бесконечные игры</li>
                      <li>Винтаж снова в моде: деградация или апгрейт?</li>
                      <li>Цифровой детокс: миф&nbsp;или&nbsp;правда?</li>
                      <li>Сборки «вручную» с&nbsp;реддита</li>
                    </ul>
                    <p>Это и&nbsp;многое другое в&nbsp;выпуске, кликай!</p>
                  </div>
                  </div>
                  <p>«Электроник» 30.10</p>
                </div>
                <div className="release_fresh-releases">
                  <img src={Cover_4}/>
                  <p>«старс» 12.10</p>
          ...
          <div className="man-finalsection">
            <img className="man-on-skate" src={man_on_skate}/>
            </div>
             <div className="chek_out-button ">
              <p>зацени полный каталог!
              </p>
              <a class="blue_button" href="#" ><span>погнали!</span></a>
            </div>
            </div>
            ...
            <section className="whats-new">
              ...
              <div className="whats-new_container">
                <div className="new_article_1">
                  ...
                  <div> <a className="white-button" href="#"><span>к статье!</span></a> </div>
                  </div>
                  <img className='new_article_1-img' src={new_article_content1_left}/>
                </div>
                <img className='new_article_1-content' src={new_article_content1}/>
              </div>
              ...
              <div className="table-games_container">
                <div className="new_article_1">
                  ...
                  <div className="table-games-img">
                    <img src={new_article_content2_left}/>
                  </div>
                </div>
  ...
  Не&nbsp;просто карточки и&nbsp;кубики&nbsp;&mdash; это целые миры с&nbsp;увлекательными механиками, стратегиями и&nbsp;кооперативными сюжетами.</p>
              ...
              <div className="anime-boom_container">
                <div className="new_article_1 displayflex">
                  <div className="anime-boom-img">
                    <img src={new_article_content3_left}/>
                  </div>
                  <div className="article_base new_article-edit-3">
                    ...
                    <div className="anime-boom-img2">
                      <img src={new_article_content3_right}/>
                    </div>
                </div>
              </div>
              <div className="vr_world">
                 <div className="article_base new_article-edit-4">
                   ...
                   <img className='new_article_4-content' src={new_article_content4}/>
              ...
              <div className="collection_merch">
                 <div className="new_article_1">
                  ...
                  <div className="table-games-img">
                    <img src={new_article_content5_left}/>
                  </div>
                </div>
                  <div className="table-games_text">
